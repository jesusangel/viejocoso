...
class SwiftMailerComponent extends Object {
	...
	private function _setup()
    {
        ...
        $this->smtpType = Configure::read('Email.smtpType');
        $this->smtpPort = Configure::read('Email.smtpPort');
        $this->smtpTimeout = Configure::read('Email.smtpTimeout');
        $this->sendmailCmd = Configure::read('Email.sendmailCmd');
        $this->smtpUsername = Configure::read('Email.smtpUsername');
        $this->smtpPassword = Configure::read('Email.smtpPassword');
        $this->sendAs = Configure::read('Email.sendAs');
