...
class DatePickerHelper extends FormHelper {
    ...
    function picker($fieldName, $options = array(), &$form) {
        $this->_setup();
	    ...
	    if (isset($options['empty'])) {
	        $options['after'] .= $this->Html->image('calendar_cancel.png', array('id'=> $htmlAttributes['id']."_drop",'style'=>'cursor:pointer'));
	    }
	    
        $output = $form->input($fieldName, $options);
